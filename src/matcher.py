...
TEAM_ALIASES = {
    ...
    # A-League (Australia)
    "melbourne victory": ["victory", "mvic"],
    "melbourne city fc": ["melbourne city", "mcty"],
    "sydney fc": ["sydney", "syd"],
    "western sydney wanderers": ["ws wanderers", "wsw"],
    "central coast mariners": ["mariners", "ccm"],
    "adelaide united": ["adelaide", "adu"],
    "brisbane roar": ["roar", "bri"],
    "perth glory": ["perth", "per"],
    "wellington phoenix": ["phoenix", "wel"],
    "newcastle jets": ["newcastle jets", "ncj"],
    "macarthur fc": ["macarthur", "mac"],
    "western united fc": ["western united", "wun"],
    "auckland fc": ["auckland", "auk"],
    # Danish Superliga
    "fc copenhagen": ["copenhagen", "cop", "fck"],
    "fc midtjylland": ["midtjylland", "fcm", "mid"],
    "fc nordsjælland": ["nordsjaelland", "fcn", "nor"],
    "brøndby if": ["brondby", "bif", "bro"],
    "aab aalborg": ["aalborg", "aab"],
    "agf aarhus": ["aarhus", "agf"],
    "silkeborg if": ["silkeborg", "sif"],
    "viborg ff": ["viborg", "vff"],
    "randers fc": ["randers", "ran"],
    "lyngby bk": ["lyngby", "lyn"],
    "vejle boldklub": ["vejle", "vej"],
    "sønderjyske": ["sonderjyske", "son"],
    # Ligue 2 (France)
    "paris fc": ["paris fc", "pfc"],
    "fc lorient": ["lorient", "lor"],
    "sc bastia": ["bastia", "bas"],
    "stade lavallois": ["laval", "lav"],
    "en avant guingamp": ["guingamp", "gui", "eag"],
    "us dunkerque": ["dunkerque", "dun"],
    "pau fc": ["pau"],
    "fc martigues": ["martigues", "mar"],
    "amiens sc": ["amiens", "ami"],
    "grenoble foot 38": ["grenoble", "gre"],
    "rodez aveyron football": ["rodez", "rod"],
    "red star fc": ["red star", "red"],
    # Belgian First Division
    "club brugge": ["brugge", "bruges", "cbr"],
    "union saint-gilloise": ["union sg", "usg"],
    "royal antwerp fc": ["antwerp", "ant", "rafc"],
    "rsc anderlecht": ["anderlecht", "and", "rsca"],
    "krc genk": ["genk", "gen"],
    "kaa gent": ["gent", "gen"],
    "standard liège": ["standard liege", "standard", "std"],
    "cercle brugge": ["cercle", "cer"],
    "oh leuven": ["leuven", "ohl"],
    "sint-truidense vv": ["sint truiden", "stvv"],
    "rwdm brussels fc": ["rwdm"],
    # Austrian Bundesliga
    "fc red bull salzburg": ["rb salzburg", "salzburg", "rbs"],
    "sk sturm graz": ["sturm graz", "sturm", "stu"],
    "sk rapid wien": ["rapid vienna", "rapid wien", "rapid"],
    "fk austria wien": ["austria vienna", "austria wien", "faw"],
    "lask linz": ["lask", "linz"],
    "wolfsberger ac": ["wolfsberg", "wac"],
    "tsv hartberg": ["hartberg", "har"],
    "scr altach": ["altach", "alt"],
    # Scottish Premiership (spl distinct from scop)
    "celtic fc": ["celtic", "cel"],
    "rangers fc": ["rangers", "ran"],
    "aberdeen fc": ["aberdeen", "abe"],
    "hearts": ["heart of midlothian", "hea"],
    "hibernian fc": ["hibernian", "hibs", "hib"],
    "dundee united": ["dundee utd", "dun"],
    "st mirren": ["st mirren", "stm"],
    "motherwell fc": ["motherwell", "mot"],
    "ross county": ["ross county", "ros"],
    "kilmarnock fc": ["kilmarnock", "kil"],
    # Greek Super League
    "olympiacos fc": ["olympiacos", "oly"],
    "panathinaikos fc": ["panathinaikos", "pan"],
    "aek athens": ["aek", "aek"],
    "paok fc": ["paok", "pao"],
    "aris thessaloniki": ["aris", "ari"],
    # MMA / Boxing — use fighter names, fuzzy match handles these
    # Rugby — Six Nations + NRL + Premiership
    "england rugby": ["england", "eng"],
    "france rugby": ["france", "fra"],
    "ireland rugby": ["ireland", "ire"],
    "scotland rugby": ["scotland", "sco"],
    "wales rugby": ["wales", "wal"],
    "italy rugby": ["italy", "ita"],
    "south africa rugby": ["south africa", "springboks", "rsa"],
    "new zealand rugby": ["new zealand", "all blacks", "nzl"],
    "australia rugby": ["australia", "wallabies", "aus"],
    # NRL
    "penrith panthers": ["penrith", "pen"],
    "melbourne storm": ["storm", "mel"],
    "sydney roosters": ["roosters", "syr"],
    "south sydney rabbitohs": ["rabbitohs", "souths", "sou"],
    "brisbane broncos": ["broncos", "bri"],
    "north queensland cowboys": ["cowboys", "nql"],
    "manly sea eagles": ["sea eagles", "manly", "man"],
    "canterbury bulldogs": ["bulldogs", "can"],
    "cronulla sharks": ["cronulla", "cro"],
    "parramatta eels": ["eels", "par"],
    "canberra raiders": ["raiders", "can"],
    "new zealand warriors nrl": ["warriors nrl", "nzw"],
    "gold coast titans": ["titans", "gct"],
    "newcastle knights": ["knights", "nck"],
    "st george illawarra dragons": ["dragons", "sgi"],
    "wests tigers": ["tigers", "wst"],
    "dolphins nrl": ["dolphins nrl", "dol"],
    # Cricket — IPL Teams
    ...
    "india cricket": ["india", "ind"],
    "australia cricket": ["australia", "aus"],
    "england cricket": ["england", "eng"],
    "pakistan cricket": ["pakistan", "pak"],
    "south africa cricket": ["south africa", "sa"],
    "new zealand cricket": ["new zealand", "nz"],
    "west indies cricket": ["west indies", "wi"],
    "sri lanka cricket": ["sri lanka", "sl"],
    "bangladesh cricket": ["bangladesh", "ban"],
    "afghanistan cricket": ["afghanistan", "afg"],
}
